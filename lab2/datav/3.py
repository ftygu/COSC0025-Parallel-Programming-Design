...
plt.plot(data_points, sse_dev_times, marker='o', linestyle='-', color='blue', label='SSE (dev)')
plt.plot(data_points, avx256_dev_times, marker='s', linestyle='--', color='green', label='AVX-256 (dev)')
plt.plot(data_points, avx512_dev_times, marker='^', linestyle='-.', color='red', label='AVX-512 (dev)')
